...
<div class="row">
    ...
    <div class="col-sm-7 col-7 text-right m-b-30">
      <a href="add-department.html" class="btn btn-primary btn-rounded">
        <i class="fa fa-plus"></i> Add Industries </a>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12">
      <div class="card-box">
        <div class="card-block">
          <h6 class="card-title text-bold">Industries</h6>
          <p class="content-group"> This page displays a comprehensive list of industries maintained in the system. Each industry entry includes its name, status, and available actions (edit or delete). The table is interactive, with features such as sorting, pagination, and the ability to select how many entries to display. This allows administrators to efficiently manage industry data with minimal effort. </p>
                  ...
                  <table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Department Name: activate to sort column ascending" style="width: 423.031px;">Industry Name</th>
                    ...
                    <tbody> <?php $counter = 1;?> @forelse ($industries as $industry) <tr role="row" class="odd">
