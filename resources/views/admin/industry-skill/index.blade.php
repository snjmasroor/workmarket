...
<div class="row">
    <div class="col-sm-5 col-5">
      <h4 class="page-title">Industry Skills</h4>
    </div>
    <div class="col-sm-7 col-7 text-right m-b-30">
      <a href="{{route('industry-skill.create')}}" class="btn btn-primary btn-rounded">
        <i class="fa fa-plus"></i> Add Industry Skills </a>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12">
