  ...
  <div class="col-md-6">
      <div class="card shadow-lg border-0">
          <div class="card-header text-center text-white">
              ...
              <small class="text-light">Industry Form</small>
          </div>
          <div class="card-body px-4 py-4">
              <form method="POST" action="{{ route('admin.industry.store') }}">
                  ...
                  <div class="mb-4">
                      <label for="industry-name" class="form-label fw-semibold">Industry Name</label>
                  ...
                  <div class="text-end">
                      <button type="submit" class="btn btn-success">
                          <i class="bi bi-plus-circle me-1"></i> Add Industry
                      </button>
                  </div>
